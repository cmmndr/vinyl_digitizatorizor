...
Upon starting the script, you will land in the main menu in which you can choose to start the recording. If you've never started the script before, you'll be asked to choose the directory you want the recordings to be saved and also which recording device you want to use.
...
There are two ways to record a vinyl, either via automated cutting or manual cutting. You will have to choose before starting to record. If you choose manual cutting, you'll be asked the name of the album artist and the name of the album. If you want the audio file to be cutted automatically, you will be asked 3 questions; Name of the Artist, Name of the Album and number of Songs. Those are needed for the correct directory structure and also the correct amount of slicing for the individual tracks.
...
* it will save a temporary flac file that gets sliced up with the sox command and some certain ([soon] configurable) parameters like silence duration etc
...
# Feature Requests
If you happen to have use for this Software, hooray!
You can also leave Feature Requests and i will try to make them happen :)
